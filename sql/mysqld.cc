...
#ifdef SMARTSSD
char *s3d_kernel_name_ptr = nullptr;
char *s3d_target_table_ptr = nullptr;
uint s3d_max_num_of_joins = 0;
#endif
...
#endif
{
  ...
  */
  ...
  fprintf(stderr, "[SMARTSSD] s3d_kernel_name_ptr:%s, s3d_target_table_ptr:%s, "
    "s3d_max_num_of_joins:%u, s3d_forced_table_scan:%u, %d %s\n", 
    s3d_kernel_name_ptr, s3d_target_table_ptr, 
    s3d_max_num_of_joins, s3d_forced_table_scan, __LINE__, __func__);
#endif
