...
#ifdef SMARTSSD
  uint s3d_len_join_tab;
  void* s3d_join_tab_cand;
  bool s3d_first_table_cand;
  uint8 nattr;
  uint16* attrs;
  void* es_fpga_mgr; 
  void* es_ndpo;
...
#ifdef SMARTSSD
    s3d_len_join_tab(0),
    s3d_join_tab_cand(NULL), s3d_first_table_cand(false),
#endif
...
#ifdef SMARTSSD
  virtual bool s3d_join_push() { return false; }
#endif
