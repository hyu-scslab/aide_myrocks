...
/**
 * CAUTION:
 * This enum is strictly matched with the list ndp_src_table_names
 * in sys_vars.cc. If you add any other tables, make sure you add it in the
 * SAME order into both sides.
 */
enum enum_ndp_src_table {
  NDP_SRC_NONE,
  NDP_SRC_SBTEST1,
  NDP_SRC_SBTEST2,
  NDP_SRC_SBTEST3,
