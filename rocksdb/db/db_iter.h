...
class DBIter final : public Iterator {
 public:
  ...
  /* Get this iterator's snapshot */
  SequenceNumber get_sequence() final override {
    if (read_options_.snapshot == nullptr) {
      return kMaxSequenceNumber;
    }

    return read_options_.snapshot->GetSequenceNumber();
  }

  ColumnFamilyData* get_cfd() {
    return cfd_;
  }
