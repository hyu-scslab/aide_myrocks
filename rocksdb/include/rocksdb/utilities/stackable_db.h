...
class StackableDB : public DB {
 public:
  ...
  using DB::FlushRequestForAIDE;
  virtual Status FlushRequestForAIDE(
      ColumnFamilyHandle* column_family,
    ...
    return db_->FlushRequestForAIDE(column_family, seq_no, 
  ...
  using DB::WaitForFlushVisibleMemTables;
  virtual Status WaitForFlushVisibleMemTables(
  ...
  virtual Status WaitForFlushVisibleMemTables(
    ...
    return db_->WaitForFlushVisibleMemTables(wait_cfd, wait_memid,
                                             fname_vector, earliest_memids,
                                             latest_memids, stall_file_deletes);
  }

  using DB::ReleaseAideInfo;
  virtual void ReleaseAideInfo(
