...
class ColumnFamilyHandle {
 public:
  ...
  virtual void GetFiles(std::vector<std::string> *files) = 0;
#endif //SMARTSSD
#ifdef VERSION_INDEX
  virtual void SetNullBytes(int nullbytes) = 0;
#endif
};
...
class DB {
 public:
  ...
  virtual Status WaitForFlushVisibleMemTables(
        ...
        std::vector<uint64_t>& latest_memids) = 0;
  virtual Status WaitForFlushVisibleMemTables(
        void* wait_cfd,
        uint64_t wait_memid,
        ...
        std::vector<uint64_t>* stall_file_deletes) = 0;
